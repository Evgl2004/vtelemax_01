...
Фактический ход производственного перехода от 26.08.2026, выполненные проверки,
ограничения и команда ручного отката зафиксированы в
[`IIKO_CLOUD_API_V2_DEPLOYMENT_2026-08-26.md`](IIKO_CLOUD_API_V2_DEPLOYMENT_2026-08-26.md).
