...
3. `Мой профиль` — показать телефон и число привязанных аккаунтов.
4. `Помощь` — подсказки по регистрации и работе с ботом.
5. `О проекте` — краткая информация о платформе.
