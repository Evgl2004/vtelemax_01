...
13. Скрипты Windows для настройки `.venv` и запуска тестов.
14. Adapter-contract тесты для согласованности поведения между Telegram/VK/MAX.
15. Тесты на `pytest` для ядра, ограничений схемы и integration/live-сценариев репозиториев.
