...
def build_default_legacy_broadcast_message() -> str:
    ...
    return (
        ...
        "• ❓ Мне только спросить — задать вопрос в отдел заботы\n"
        "• 💼 Вакансии — актуальные вакансии в ресторанах\n"
        "• ✍️ Оставить отзыв — форма обратной связи\n"
        "• 🍽️ Бизнес-ланч — просмотр меню бизнес-ланча\n"
        "• 🪑 Бронь стола — онлайн бронирование столиков\n"
